...
pub use sase_core::projections::{
    AceAgentSnapshotReadRequestWire, AgentArchiveReadResponseWire,
    ...
    ChangeSpecReadListResponseWire, LocalDaemonMutationOutcomeWire,
    MutationActorWire, MutationConflictWire,
...
pub use sase_core::provider_host::{
    ...
    HostWorkspaceIdentityWire, HOST_CAP_IPC_V1, HOST_CAP_LLM_INVOKE,
...
pub enum LocalDaemonReadRequestWire {
    ...
    AceAgentSnapshot(AceAgentSnapshotReadRequestWire),
...
pub enum LocalDaemonReadResponseWire {
    ...
    AceAgentSnapshot(AgentReadListResponseWire),
