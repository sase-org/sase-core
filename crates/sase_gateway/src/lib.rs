...
pub use daemon::{
    ...
    storage_layout_diagnostics, validate_daemon_config, DaemonConfig,
    DaemonConfigOptions, DaemonRunError, DaemonRuntime, DaemonRuntimePaths,
    DaemonShutdown, DaemonState,
};
pub use host_bridge::{
...
pub use wire::{
    ...
    LocalDaemonIndexingDiffResponseWire, LocalDaemonIndexingStatusRequestWire,
