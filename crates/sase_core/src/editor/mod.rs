...
pub use wire::{
    ...
    CompletionContextKind, CompletionList, DiagnosticSeverity,
    DirectiveClauseContext, DirectiveClauseKind,
    DirectiveCompletionInventories, DirectiveContractEntry,
    DirectiveKeywordContract, DirectiveKeywordSpec, DirectiveMetadata,
    DirectiveModelAliasKey, DirectiveModelEntry, DirectiveSuggestedValue,
