...
pub use artifact::{
    ...
    upsert_artifact_node, upsert_artifact_payload, ArtifactDetailWire,
    ArtifactDoctorIssueWire, ArtifactDoctorOptionsWire, ArtifactDoctorWire,
    ArtifactGraphOptionsWire, ArtifactGraphWire, ArtifactKindWire,
    ...
    ArtifactQueryWire, ArtifactStore, ARTIFACT_KIND_AGENT, ARTIFACT_KIND_BEAD,
