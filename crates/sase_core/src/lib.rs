...
pub use artifact::{
    ...
    artifact_show, artifact_show_paged, deterministic_artifact_link_id,
    open_artifact_store, remove_artifact_link, remove_artifact_node,
    upsert_artifact_link, upsert_artifact_node, upsert_artifact_payload,
    ArtifactDetailPagedWire, ArtifactDetailWire, ArtifactDoctorIssueWire,
    ArtifactDoctorOptionsWire, ArtifactDoctorWire, ArtifactGraphOptionsWire,
    ArtifactGraphWire, ArtifactGroupSummaryWire, ArtifactKindWire,
    ArtifactLinkRemoveWire, ArtifactLinkTypeWire, ArtifactLinkUpsertWire,
    ArtifactLinkWire, ArtifactMutationResultWire, ArtifactNodeRemoveWire,
    ArtifactNodeUpsertWire, ArtifactNodeWire, ArtifactPageRequestWire,
    ArtifactPayloadWire, ArtifactQueryWire, ArtifactRelationPageWire,
    ArtifactStore, ArtifactTypeCountWire, ARTIFACT_KIND_AGENT,
