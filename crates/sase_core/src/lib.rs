...
pub use bead::{
    ...
    needs_task_type_migration, open_issue as bead_open_issue,
    ...
    JsonlLoadOutcome, PhaseSizeWire, RemovedFlagStreamPruneOutcomeWire,
    StatusWire, BEAD_EVENT_SCHEMA_VERSION, BEAD_HISTORY_WIRE_SCHEMA_VERSION,
