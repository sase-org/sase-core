...
pub use bead::{
    ...
    needs_model_migration, needs_size_check_relax_migration,
    needs_size_migration, open_issue as bead_open_issue, parse_issues_jsonl,
...
pub use editor::{
    ...
    AtReferencePathRowWire, AtReferencePayloadIndex, AtReferencePayloadRowWire,
    AtReferenceRowWire, AtReferenceStage, CompletionCandidate,
    ...
    FrontmatterFieldSchema, FrontmatterInputType, FuzzyMatch, HoverPayload,
    PlaceholderCandidate, PlaceholderCandidateSource, PlaceholderCompletion,
    PlaceholderContext, PlaceholderSpan, RawPlaceholderField, TokenInfo,
