...
pub use agent_scan::{
    ...
    rebuild_agent_artifact_index, replace_dismissed_agent_visibility,
    scan_agent_artifact_dir, scan_agent_artifacts,
    upsert_agent_artifact_index_row, upsert_dismissed_agent_visibility,
    ...
    DismissedAgentIdentityWire, DoneMarkerWire, PlanPathMarkerWire,
...
pub use bead::{
    ...
    show_issue as bead_show_issue, stats as bead_stats,
    ...
    BeadPreclaimAssignmentWire, BeadPreclaimRollbackWire, BeadTierWire,
    BeadUpdateFieldsWire, DependencyWire, IssueTypeWire, IssueWire,
    JsonlLoadOutcome, OperationOutcomeWire, StatusWire,
