...
pub use bead::{
    add_bead_references, add_dependency as bead_add_dependency,
    apply_prefix_migration as bead_prefix_migration_apply, bead_history,
    ...
    needs_task_ready_migration, open_issue as bead_open_issue,
    parse_issues_jsonl,
    preclaim_epic_work_plan as bead_preclaim_epic_work_plan,
    preview_prefix_migration as bead_prefix_migration_preview,
    ...
    rewrite_id_tokens as bead_rewrite_id_tokens, save_config,
    search_issues as bead_search_issues, show_issue as bead_show_issue,
    show_issue_detail as bead_show_issue_detail,
    size_check_relax_migration_sql, size_migration_sql, stats as bead_stats,
    sync_is_clean as bead_sync_is_clean, task_ready_migration_sql,
    unmark_ready_to_work as bead_unmark_ready_to_work,
    update_issue as bead_update_issue, update_issues as bead_update_issues,
    validate_issue_prefix as bead_validate_issue_prefix, BeadConfigWire,
    BeadCreateRequestWire, BeadDoctorReportWire, BeadError,
    ...
    BeadEventStoreManifestWire, BeadEventStreamWire, BeadHistoryChangeWire,
    BeadHistoryEntryWire, BeadHistoryWire, BeadIdTokenRewriteOutcomeWire,
    BeadIssueDetailWire, BeadIssueUpdateEventFieldsWire,
    BeadMutationOutcomeWire, BeadPreclaimAssignmentWire,
    BeadPreclaimRollbackWire, BeadPrefixMigrationOutcomeWire,
    BeadPrefixMigrationRequestWire, BeadProjectionDriftWire,
    BeadSearchMatchWire, BeadTierWire, BeadUpdateFieldsWire, DependencyWire,
    IssueTypeWire, IssueWire, JsonlLoadOutcome, PhaseSizeWire, StatusWire,
