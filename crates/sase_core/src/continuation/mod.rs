...
pub use schema::{
    ...
    AgentDeltaStatusWire, AgentDeltaWire, ContinuationAttributionWire,
    ContinuationByteRangeWire, ContinuationCheckpointCoverageWire,
    ...
    ContinuationError, ContinuationExecutionIdentityWire,
    ...
    ContinuationOmissionWire, ContinuationPromptSegmentProvenanceWire,
    ContinuationPromptSegmentWire, ContinuationRenderedComponentWire,
