...
pub fn builtin_artifact_relations() -> Vec<ArtifactRelationWire> {
    vec![
        ...
        ArtifactRelationWire::builtin(
            ...
            true,
            "projection",
            "The job is the source; the agent it launched is the target.",
            "job:refresh_docs/refresh_docs launched agent:sase-tj.land",
            "agent:sase-tj.land launched job:refresh_docs/refresh_docs",
            &["job", "chop"],
            &["agent"],
        ),
        ArtifactRelationWire::builtin(
