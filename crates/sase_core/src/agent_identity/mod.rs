...
pub(crate) use identity::historical_agent_session_scope;
...
pub use identity::{
    ...
    agent_name_in_hood_with_owner_roots, foreign_agent_owner_root,
    globalize_agent_name, globalize_owned_agent_name,
    normalize_agent_archive_name, normalize_owned_agent_name,
    parse_agent_session_name, parse_owned_agent_name, strip_global_agent_name,
    ...
    AgentSessionNameWire, OwnedAgentNameWire, OwnerRoot,
};
