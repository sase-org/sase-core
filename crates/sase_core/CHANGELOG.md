...
- *(plan)* add bead show validation for plan guard
...
- *(tool-run)* persist canonical before/after fingerprints on finish
...
- *(gateway)* advertise fleet_contract_schema_version independently of capabilities

## [0.34.63](https://github.com/sase-org/sase-core/compare/v0.34.62...v0.34.63) - 2026-09-19

### Added

- *(tool-run)* add ToolRun store, PyO3 bindings, and reserved tool kind
...
- *(hold)* persist capture summaries and return prune evidence

## [0.34.60](https://github.com/sase-org/sase-core/compare/v0.34.59...v0.34.60) - 2026-09-19

### Added

- *(hold)* unify CLI and directive selector identity

## [0.34.59](https://github.com/sase-org/sase-core/compare/v0.34.58...v0.34.59) - 2026-09-19
...
- *(fleet)* expose owner-resolved presentation facts

## [0.34.57](https://github.com/sase-org/sase-core/compare/v0.34.56...v0.34.57) - 2026-09-18

### Added

- *(sudo)* retain optional remote handoff metadata on attempts

## [0.34.56](https://github.com/sase-org/sase-core/compare/v0.34.55...v0.34.56) - 2026-09-18

### Added

- *(agent-scan)* add default-off Agents-list projection mode
...
## [0.34.54](https://github.com/sase-org/sase-core/compare/v0.34.53...v0.34.54) - 2026-09-18

### Added

- *(sudo)* add completion authorization core contracts

## [0.34.53](https://github.com/sase-org/sase-core/compare/v0.34.52...v0.34.53) - 2026-09-18

### Added

- *(finalizer)* select remaining declared repos after repair
- *(bead)* add atomic bulk link-projection mutation
- *(wait)* add hood directive contract
- *(sudo)* preserve detached runner ownership and live output
...
- *(sudo)* add detached runner execution
- *(editor)* support hold completion roles

## [0.34.51](https://github.com/sase-org/sase-core/compare/v0.34.50...v0.34.51) - 2026-09-18

### Fixed

- *(machine-setup)* make completed review terminal

## [0.34.50](https://github.com/sase-org/sase-core/compare/v0.34.49...v0.34.50) - 2026-09-18

### Added

- *(gate-decision)* complete policy evidence contract
...
- *(service)* add status snapshot wire

## [0.34.47](https://github.com/sase-org/sase-core/compare/v0.34.46...v0.34.47) - 2026-09-17

### Fixed

- *(core)* support linked repo redirects

## [0.34.46](https://github.com/sase-org/sase-core/compare/v0.34.45...v0.34.46) - 2026-09-17

### Added

- *(service)* add restart and state core

### Fixed

- *(config)* preserve legacy routine timeout mutation sources

## [0.34.45](https://github.com/sase-org/sase-core/compare/v0.34.44...v0.34.45) - 2026-09-17

### Added

- *(agent-publication)* add bounded batch planner
...
- canonicalize Claude Fable usage identity
...
- *(core)* add hold directive contracts

## [0.34.38](https://github.com/sase-org/sase-core/compare/v0.34.37...v0.34.38) - 2026-09-16

### Added

- *(agent)* expose proc hold admission facts
- *(gate-decision)* add decide_gate_lifecycle classifier

## [0.34.37](https://github.com/sase-org/sase-core/compare/v0.34.36...v0.34.37) - 2026-09-16

### Added

- *(runner-capacity)* apply agent hold barriers

## [0.34.36](https://github.com/sase-org/sase-core/compare/v0.34.35...v0.34.36) - 2026-09-16

### Added

- *(agent-tribes)* add context-aware identity resolution
- *(axe)* add public status projection
- *(agent-tribes)* add job alias core bindings
- *(config)* share axe config normalization
- *(lsp)* complete xprompt semantic token coverage
- *(agent-launch)* parse proc queue directives
- *(agent-hold)* add durable hold store
- add xprompt argument span grammar
- *(agent-launch)* add static conditional segment filtering
- *(artifact-ref)* add job alias for chop refs
- plan double-colon argument edits
- *(axe)* normalize routine/job config names
- *(machine-setup)* add machine init review policy
- *(disk)* add inventory classification contract

### Fixed

- *(axe)* canonicalize routine diagnostic templates
- *(config)* preserve axe source edit paths
- *(editor)* expose static directive argument spans
- *(editor)* preserve open argument spans
- *(agent-hold)* enforce hold boundary semantics
- *(core)* enforce cleanup safety contracts
- *(objects)* guard existing borrower repoints
- *(provider-usage)* let reminders yield to cadence
- *(retention)* harden artifact run pruning safety

## [0.34.35](https://github.com/sase-org/sase-core/compare/v0.34.34...v0.34.35) - 2026-09-15

### Added

- *(bead)* add target routing policy

## [0.34.34](https://github.com/sase-org/sase-core/compare/v0.34.33...v0.34.34) - 2026-09-15

### Added

- *(xprompt)* expose skill definition resolution

## [0.34.33](https://github.com/sase-org/sase-core/compare/v0.34.32...v0.34.33) - 2026-09-15

### Fixed

- *(procs)* fail closed on incomplete runtime stores

## [0.34.32](https://github.com/sase-org/sase-core/compare/v0.34.31...v0.34.32) - 2026-09-15

### Fixed

- *(fleet)* suppress terminal family member rows

## [0.34.31](https://github.com/sase-org/sase-core/compare/v0.34.30...v0.34.31) - 2026-09-15

### Fixed

- *(managed-tmp)* report cleanup outcomes
...
## [0.34.29](https://github.com/sase-org/sase-core/compare/v0.34.28...v0.34.29) - 2026-09-15

### Fixed

- *(fleet)* accept compatible capability summaries

## [0.34.28](https://github.com/sase-org/sase-core/compare/v0.34.27...v0.34.28) - 2026-09-14

### Fixed

- *(agent-cleanup)* add forced reuse stop barrier

## [0.34.27](https://github.com/sase-org/sase-core/compare/v0.34.26...v0.34.27) - 2026-09-14

### Added

- *(sudo)* add reviewed sudo runner contracts
- *(managed-tmp)* lower pressure age under low space
- *(core)* plan git object sharing rewrites
- Complete protected run retention and empty-shard cleanup (sase-zw.8.3)
- *(procs)* add runtime retention owner
- *(editor)* support argument colon on-type edits

### Fixed

- *(fleet_contract)* accept explicit zero queue weight in scan and validation
...
- *(runner_capacity)* accept explicit zero-weight capacity records
...
- *(provider_usage)* make indicator projection order deterministic
- *(continuation)* decouple retention run cap from MAX_NODES via new MAX_RETENTION_RUNS constant
- *(managed-tmp)* make statvfs math and ErrorKind import portable to macOS
- *(editor)* honor queue flag in directive completion
- *(agent-scan)* project every live machine value into candidate filters
- *(agent-scan)* discover source dirs before claiming complete history
...
- *(fleet)* honor dismissals of definitively dead agent records
...
- *(retryability)* classify git and gh failures

## [0.34.20](https://github.com/sase-org/sase-core/compare/v0.34.19...v0.34.20) - 2026-09-12
...
- *(provider-priority)* add pool eligibility and reservation policy operations
...
## [0.34.18](https://github.com/sase-org/sase-core/compare/v0.34.17...v0.34.18) - 2026-09-12

### Added

- *(continuation)* add ordinary delivery reservation transitions

## [0.34.17](https://github.com/sase-org/sase-core/compare/v0.34.16...v0.34.17) - 2026-09-12

### Added

- *(continuation)* freeze validated monitor outcome policies
...
- *(agent-scan)* expose monitor workflow metadata

## [0.34.14](https://github.com/sase-org/sase-core/compare/v0.34.13...v0.34.14) - 2026-09-11

### Added

- *(agent-scan)* set-based dismissed-family reconcile and diff replace

## [0.34.13](https://github.com/sase-org/sase-core/compare/v0.34.12...v0.34.13) - 2026-09-11

### Added

- *(continuation)* evaluate and consume host completion intents

## [0.34.12](https://github.com/sase-org/sase-core/compare/v0.34.11...v0.34.12) - 2026-09-11

### Added

- *(queue)* replace runners with weighted-load capacity contract
...
- Bound continuation context without losing instructions (sase-zl.10)
...
## [0.34.6](https://github.com/sase-org/sase-core/compare/v0.34.5...v0.34.6) - 2026-09-11

### Added

- *(continuation)* expose stable replay blocks
- *(continuation)* validate launch requester continuations

## [0.34.5](https://github.com/sase-org/sase-core/compare/v0.34.4...v0.34.5) - 2026-09-11

### Fixed

- add sidecar publication policy

## [0.34.4](https://github.com/sase-org/sase-core/compare/v0.34.3...v0.34.4) - 2026-09-11

### Fixed

- *(bead)* repair projection receipt convergence

## [0.34.3](https://github.com/sase-org/sase-core/compare/v0.34.2...v0.34.3) - 2026-09-11

### Added

- Define the Rust continuation and result contracts (sase-zl.2)

## [0.34.2](https://github.com/sase-org/sase-core/compare/v0.34.1...v0.34.2) - 2026-09-11

### Fixed

- *(artifact-links)* require durable bead history receipt

## [0.34.1](https://github.com/sase-org/sase-core/compare/v0.34.0...v0.34.1) - 2026-09-11

### Fixed

- *(agent-launch)* preserve prose code-directive mentions
...
- add usage indicator policy projection
- *(core)* land native PatchWire parser and shared-format conversion contracts
- *(core)* add weighted queue capacity contracts
- *(agent-launch)* add predecessor wait binding
- *(editor)* [**breaking**] use equals model shortcuts

### Fixed

- *(gateway)* settle fleet launches durably

### Other

- *(migration)* classify legacy patch heading

## [0.32.61](https://github.com/sase-org/sase-core/compare/v0.32.60...v0.32.61) - 2026-09-09

### Added

- *(fleet)* add pending attention inventory contract
- *(fleet)* normalize federation read envelopes
- *(core)* add model completion support
- *(beads)* support link operation ids
...
- *(provider-usage)* expose collector health
...
- *(editor)* reject unsafe model shortcut values

## [0.32.56](https://github.com/sase-org/sase-core/compare/v0.32.55...v0.32.56) - 2026-09-09

### Added

- add artifact link event contract

## [0.32.55](https://github.com/sase-org/sase-core/compare/v0.32.54...v0.32.55) - 2026-09-09

### Added

- *(editor)* add explicit model shortcut LSP support
...
- *(xprompt)* make queue directive unconditional
...
- *(core)* add machine-setup Tailnet discovery and enrollment reconciliation policy
- *(core)* derive followed-batch singleton-to-family follow promotions
...
## [0.32.49](https://github.com/sase-org/sase-core/compare/v0.32.48...v0.32.49) - 2026-09-08

### Fixed

- *(provider)* widen disable lock wait

## [0.32.48](https://github.com/sase-org/sase-core/compare/v0.32.47...v0.32.48) - 2026-09-08

### Added

- *(core)* add artifact_link_eligibility policy module
- *(core)* decide managed origin reconciliation

### Fixed

- *(model-alias)* exclude jinja shortcut regions
...
- *(artifact-ref)* require proved owner provenance for source-directory hits
...
- *(artifact-ref)* resolve document-owned source paths by repository identity
...
- *(fleet)* add remote launch dispatch contract
...
- *(agent-ownership)* add batch ownership planner

## [0.32.32](https://github.com/sase-org/sase-core/compare/v0.32.31...v0.32.32) - 2026-09-07

### Added

- *(gateway)* add local federation worker

## [0.32.31](https://github.com/sase-org/sase-core/compare/v0.32.30...v0.32.31) - 2026-09-06

### Added

- *(gateway)* add fleet read API
...
- *(fleet)* add portable identity contracts

## [0.32.27](https://github.com/sase-org/sase-core/compare/v0.32.26...v0.32.27) - 2026-09-06

### Added

- *(provider)* add provider priority core policy

## [0.32.26](https://github.com/sase-org/sase-core/compare/v0.32.25...v0.32.26) - 2026-09-06

### Added

- *(core)* add bounded text tail primitive
...
- *(prompt)* add prompt archive inventory
...
- *(agent)* persist imported_source_owner through scan wire
...
## [0.32.16](https://github.com/sase-org/sase-core/compare/v0.32.15...v0.32.16) - 2026-08-29

### Fixed

- *(directives)* bound unterminated argument ranges

## [0.32.15](https://github.com/sase-org/sase-core/compare/v0.32.14...v0.32.15) - 2026-08-29

### Fixed

- *(agent-launch)* transfer workspace claim names

## [0.32.14](https://github.com/sase-org/sase-core/compare/v0.32.13...v0.32.14) - 2026-08-28

### Fixed

- *(agent-scan)* give the windowed completed tier its own budget
...
- *(agent-scan)* derive missing finished_at from stopped_at
...
- *(agent-scan)* support windowed index reads

## [0.32.11](https://github.com/sase-org/sase-core/compare/v0.32.10...v0.32.11) - 2026-08-27

### Added

- *(agent-scan)* project list-shaped artifact records

## [0.32.10](https://github.com/sase-org/sase-core/compare/v0.32.9...v0.32.10) - 2026-08-27

### Added

- *(agent-scan)* add read-only index opens and a VACUUM binding

### Other

- *(agent-scan)* marshal artifact index directly to Python

## [0.32.9](https://github.com/sase-org/sase-core/compare/v0.32.8...v0.32.9) - 2026-08-27

### Added

- *(agent-scan)* fold monitor_*/gate_* wire fields into nested family_shell at schema v7

## [0.32.8](https://github.com/sase-org/sase-core/compare/v0.32.7...v0.32.8) - 2026-08-26

### Added

- *(artifact-links)* add projection relation builtins

## [0.32.7](https://github.com/sase-org/sase-core/compare/v0.32.6...v0.32.7) - 2026-08-26

### Added

- scan gate shell read metadata

## [0.32.6](https://github.com/sase-org/sase-core/compare/v0.32.5...v0.32.6) - 2026-08-26

### Added

- *(plan)* allow transient links frontmatter
- *(bead-links)* track link direction and uses count in bead-owned link events

### Fixed

- restore sase-core check gate

## [0.32.5](https://github.com/sase-org/sase-core/compare/v0.32.4...v0.32.5) - 2026-08-25

### Added

- *(artifact-link)* add relation module for link relation queries
...
- *(query)* widen boolean tokenizer values

## [0.32.3](https://github.com/sase-org/sase-core/compare/v0.32.2...v0.32.3) - 2026-08-24

### Added

- *(glossary)* add source-backed wire v2

## [0.32.2](https://github.com/sase-org/sase-core/compare/v0.32.1...v0.32.2) - 2026-08-24

### Fixed

- *(bead)* preserve legacy event-stream byte prefixes when appending JSONL writes

## [0.32.1](https://github.com/sase-org/sase-core/compare/v0.32.0...v0.32.1) - 2026-08-24

### Added

- *(bead)* default the notes column to an empty structured list

## [0.32.0](https://github.com/sase-org/sase-core/compare/v0.31.14...v0.32.0) - 2026-08-24

### Added

- *(bead)* [**breaking**] store notes as structured records

## [0.31.14](https://github.com/sase-org/sase-core/compare/v0.31.13...v0.31.14) - 2026-08-24

### Added

- *(memory)* support core and reference memory tiers
...
- *(xprompt)* close [[...]] blocks at terminator-position ]]
...
- *(xprompt)* close `[[...]]` argument text blocks at terminator-position `]]` in the editor, directive, and agent-launch scanners
- *(xprompt)* decode `+` to a space only for bare colon arguments
...
- *(agent-launch)* native `%proc` dispatch helpers: private 0600 scripts,
  sanitized proc environment, duration/cwd/workspace policy, and additive
  `xprompt_proc` proc-store metadata
...
- *(editor)* expose directive recipe authoring contract
- *(agent-launch)* plan durable admission journal actions
- *(agent-launch)* plan typed launch units
- *(editor)* add CodeValue, fence scanner, and gated if/proc
...
- *(agent-launch)* sandboxed `%if` condition evaluator with versioned
  `SASE_CONDITION_CONTEXT`, private 0600 scripts, process-group timeout,
  and exit 0/1/other classification

## [0.31.2](https://github.com/sase-org/sase-core/compare/v0.31.1...v0.31.2) - 2026-08-22

### Other

- *(changelog)* describe 0.31.0 as a metadata follow-up

## [0.31.1](https://github.com/sase-org/sase-core/compare/v0.31.0...v0.31.1) - 2026-08-22

### Fixed

- *(bead)* allow land-only epic work plans
...
- *(agent-scan)* persist optional monitor_next_model

## [0.29.11](https://github.com/sase-org/sase-core/compare/v0.29.10...v0.29.11) - 2026-08-22

### Fixed

- *(editor)* expose final directive completions
...
- *(finalizer)* validate and authenticate resolved plan digests

### Added

- *(finalizer)* validate unique increasing attempt ledgers and coherent terminal status
- *(finalizer)* validate and authenticate a resolved plan against an independently held digest
...
- *(editor)* hide final directive from name completions
...
## [0.29.2](https://github.com/sase-org/sase-core/compare/v0.29.1...v0.29.2) - 2026-08-19

### Fixed

- *(agent_cleanup)* dismiss clan family members and monitors directly
...
- *(task_type)* drop `flag` from reserved task-type slugs so a project may claim it
...
## [0.27.17](https://github.com/sase-org/sase-core/compare/v0.27.16...v0.27.17) - 2026-08-16

### Added

- *(beads)* exclude flags from external ref ownership

## [0.27.16](https://github.com/sase-org/sase-core/compare/v0.27.15...v0.27.16) - 2026-08-16

### Other

- *(bead)* write only changed event streams
...
- *(bead)* add `IssueTypeWire::Flag`, `BeadFlagWire`, and flag-type SQLite migration
- *(agent_scan)* project launch-time model-alias trails in schema 22 and query bounded alias history
...
- *(bead)* make issue_updated resolution round-trip stable
...
- parse and resolve output-variable selectors for precise get queries
...
- *(model_route)* add size-alias and epic-land model routing primitives

## [0.27.6](https://github.com/sase-org/sase-core/compare/v0.27.5...v0.27.6) - 2026-08-15

### Fixed

- *(notifications)* preserve snooze microsecond timestamps
...
- *(query)* parameterize the parser, corpus, and evaluator by compiled profile
...
## [0.27.2](https://github.com/sase-org/sase-core/compare/v0.27.1...v0.27.2) - 2026-08-14

### Added

- support provider-scoped model completions in LSP

## [0.27.1](https://github.com/sase-org/sase-core/compare/v0.27.0...v0.27.1) - 2026-08-14

### Fixed

- support marking notification tabs read
...
## [0.26.11](https://github.com/sase-org/sase-core/compare/v0.26.10...v0.26.11) - 2026-08-13

### Added

- *(agent_scan)* carry monitor follow-up disposition in scan wire

## [0.26.10](https://github.com/sase-org/sase-core/compare/v0.26.9...v0.26.10) - 2026-08-13

### Added

- *(snippet-session)* add nested snippet session state machine
...
## [0.26.7](https://github.com/sase-org/sase-core/compare/v0.26.6...v0.26.7) - 2026-08-12

### Added

- *(agent-scan)* add monitor marker fields to the agent scan wire
