...
fn legend_epic_count_round_trips_jsonl() {
    let input = r#"{"id":"gold-legend","title":"Legend","status":"open","issue_type":"plan","tier":"legend","parent_id":null,"owner":"","assignee":"","created_at":"2026-01-01T00:00:00Z","created_by":"","updated_at":"2026-01-01T00:00:00Z","closed_at":null,"close_reason":null,"description":"","notes":"","design":"plans/legend.md","model":"claude/opus","is_ready_to_work":false,"epic_count":4,"changespec_name":"","changespec_bug_id":"","dependencies":[]}
"#;
    let outcome = parse_issues_jsonl(input);
    assert_eq!(outcome.issues[0].epic_count, Some(4));
    assert_eq!(outcome.issues[0].model, "claude/opus");
